...
// Вести нижнюю часть стрелки в точку с относительнымиb координатами(-10, 0)
...
// Вычисляем смещение Y от точки верхней точки (maxY)
    ...
    /* Метод-помощник, возвращющий экземпляр класса Point2D.Double
     * смещѐнный по отношению  исходному на deltaX, deltaY
